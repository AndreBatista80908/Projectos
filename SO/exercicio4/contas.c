...
int debitar(int idConta, int valor) {
    ...
    sprintf(strComando, "debitar(%d, %d)\n", idConta, valor);
    logFile = open("log.txt", O_WRONLY, O_APPEND);
    write(logFile, strComando, strlen(strComando));
    close(logFile);
...
int creditar(int idConta, int valor) {
    ...
    sprintf(strComando, "creditar(%d, %d)\n", idConta, valor);
    logFile = open("log.txt", O_WRONLY, O_APPEND);
    write(logFile, strComando, strlen(strComando));
    close(logFile);
...
int transferir(int idContaOrigem, int idContaDestin, int valor) {
    ...
    sprintf(strComando, "transferir(%d, %d, %d)\n", idContaOrigem, idContaDestin, valor);
    logFile = open("log.txt", O_WRONLY, O_APPEND);
    write(logFile, strComando, strlen(strComando));
    close(logFile);
